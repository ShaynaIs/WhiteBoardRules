...
<div class="flexContent notLoggedIn">
    <div class="leftContent">
        ...
        <ul class="rslides">
            <li><img src="images/Samples/1.JPG" alt=""></li>
            <li><img src="images/Samples/2.JPG" alt=""></li>
            <li><img src="images/Samples/3.JPG" alt=""></li>
            <li><img src="images/Samples/4.JPG" alt=""></li>
        </ul>
    </div>
                ...
                <div class="form-container">
                    <form method="post" action="process_login.php" class="login-form">
                        <div class="form-border">
                            ...
                            <p class='btn' style="text-align:center">Not Registered? <a href="sign_up.php">Sign Up</a></p>
                        </div>
                    </form>
                </div>
            </div>
